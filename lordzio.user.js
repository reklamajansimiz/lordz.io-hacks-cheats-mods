...
// @updateURL    https://iomods.org/mods/lordzio.user.js
// @downloadURL  https://iomods.org/mods/lordzio.user.js
// @match        *://www.lordz.io/*
// @match        *iogames.space/*
// @match        *titotu.io/*
// @match        *io-games.io/*
...
//degisenkisimlar
$('.hud-intro-more-games').prepend('<div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div>');
